...
{ 
 ...
 public: 
  ...
  virtual StatusCode fill( const INavigable4Momentum* /* part */, const double /* weight */ ) = 0;

  /// Method to fill histograms
  virtual StatusCode fill( const INavigable4Momentum* /* part */, const Trk::VxCandidate* /* primVtx */, const double /* weight */ ) = 0;
